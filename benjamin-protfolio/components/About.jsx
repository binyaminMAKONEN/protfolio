    ...
    <div  className='w-full md:h-screen p-2 flex items-center py-10'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          Hi, I am a graduate of the software development course at Tech-Career College. From a young age I have always been deeply fascinated by computers and technology. After many thoughts I decided that software development is the profession I would like to pursue. Along with the skills I acquired in college and my personal skills, I will bring with me a strong work ethic, self-learning ability, high motivation to learn new systems and good teamwork.
          </p>
          <p className='py-2  text-gray-600 dark:text-white'>
